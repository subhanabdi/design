        ...
        <div className="grid lg:grid-cols-4 gap-20 items-start">
          ...
          <div className="lg:col-span-3 grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-16">
            ...
            {clients.map((client) => (
              ...
              >
                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition duration-300 relative w-63 h-14 transition duration-300 opacity-70 hover:opacity-100 hover:scale-105">
                  <Image
                    src={client.logo}
                    alt={client.name}
                    fill
